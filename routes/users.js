...
router.post('/register', async (req, res, next) => {
    try {
        ...
        const message = `
        <div style="padding:30px ;font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;text-align: center; background-color:#eae3c8; color:#383e56; border-radius: 5px;">
